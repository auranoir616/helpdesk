...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <a href="<?php echo site_url('admin/admin-tiket-pending') ?>">
    ...
    ?>
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <a href="<?php echo site_url('admin/admin-tiket-process') ?>">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <a href="<?php echo site_url('admin/admin-tiket-complete') ?>">
...
<div class="card">
    <div class="card-header flex-row justify-content-between">
        ...
        <!-- <a href="<?php echo base_url('admin/admin-new-tiket') ?>" class="btn btn-primary">
    ...
    <div class="card-body">
        <div class="table-responsive">
            ...
            <table class="table border text-nowrap text-md-nowrap table-striped mb-0">
                ...
                <tbody>
                    <?php  
                    $this->db->where('notif_useridto', 0);
                    ...
                    foreach ($getNotif as $show) {
                        ?>
                        <tr onclick="window.location.href='<?php echo base_url('admin/tiket-detail?id=' . $show->notif_tiketid) ?>'" style="cursor:pointer;">
                            <td><?php echo $no++ ?></td>
                            <td><?php echo $show->notif_desc ?></td>
                            <td><?php echo waktuYangLalu($show->notif_date) ?></td>
                            <td><a href="javascript:void(0)" onclick="bacanotif('<?php echo $show->notif_id ?>', event)">Hapus</a></td>
                   <?php } ?>
                </tbody>
            </table>
