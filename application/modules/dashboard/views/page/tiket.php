<div class="card">
  <div class="card-header d-flex justify-content-between">
   ...
   <?php if(userdata()->user_type == 'user'): ?>
   <a href="<?php echo base_url('new-tiket') ?>" class="btn btn-primary">Tambah Tiket</a>
   <?php endif ?>
</div>
 ...
 if ($search) {
    ...
    <span class="badge 
        ...
        <td>
          ...
          <button onclick="hapustiket('<?php echo $show->tiket_id ?>', event)" class="btn btn-sm btn-danger">Hapus Tiket</button>
          <?php else: ?>
